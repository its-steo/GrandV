      ...
      <div className="ml-0 md:ml-64 p-3 sm:p-4 md:p-6">
        <div className="max-w-7xl mx-auto space-y-4 sm:space-y-6">
          ...
          {isApproved && installmentOrders.length > 0 && (
            <div className="grid gap-3 sm:gap-4 grid-cols-2 lg:grid-cols-4">
              <Card className="bg-white/10 border-white/20 backdrop-blur-md">
                <CardContent className="p-3 sm:p-4">
                  <div className="flex items-center gap-2 sm:gap-3">
                    ...
                    <div>
                      <p className="text-xs sm:text-sm text-white/80">Active Plans</p>
              ...
              <Card className="bg-white/10 border-white/20 backdrop-blur-md">
                <CardContent className="p-3 sm:p-4">
                  <div className="flex items-center gap-2 sm:gap-3">
                    <div className="p-1.5 sm:p-2 bg-orange-900/30 rounded-lg flex-shrink-0">
                      <DollarSign className="h-4 w-4 sm:h-5 sm:w-5 text-orange-600" />
                    </div>
                    <div>
                      <p className="text-xs sm:text-sm text-white/80">Total Owed</p>
              ...
              <Card className="bg-white/10 border-white/20 backdrop-blur-md">
                <CardContent className="p-3 sm:p-4">
                  <div className="flex items-center gap-2 sm:gap-3">
                    <div className="p-1.5 sm:p-2 bg-green-900/30 rounded-lg flex-shrink-0">
                      <TrendingUp className="h-4 w-4 sm:h-5 sm:w-5 text-green-600" />
                    </div>
                    <div>
                      <p className="text-xs sm:text-sm text-white/80">Total Paid</p>
                  ...
                  <div className="flex items-center gap-2 sm:gap-3">
                    <div
                      className={`p-1.5 sm:p-2 rounded-lg flex-shrink-0 ${
                        stats.overdueOrders > 0 ? "bg-red-900/30" : "bg-green-900/30"
                      }`}
                    >
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4 sm:space-y-6">
            <TabsList className="bg-white/10 border-white/20 backdrop-blur-md grid w-full grid-cols-2 sm:grid-cols-4 h-auto">
              <TabsTrigger
                value="registration"
              ...
              {isApproved ? (
                ...
                <Card className="bg-white/10 border-white/20 backdrop-blur-md text-center py-8 sm:py-12">
                  <CardContent className="px-4">
                    <Package className="h-8 w-8 sm:h-12 sm:w-12 text-white/80 mx-auto mb-4" />
                    <h3 className="text-lg font-semibold mb-2 text-white">Registration Required</h3>
                    <p className="text-sm sm:text-base text-white/80 mb-4">
                      Complete your Lipa Mdogo Mdogo registration to access installment products.
                    </p>
                    <Button onClick={() => setActiveTab("registration")} className="w-full sm:w-auto bg-gradient-to-r from-blue-500 to-indigo-500 text-white">
                      Go to Registration
                    </Button>
                  </CardContent>
                </Card>
              ...
              {installmentOrders.length > 0 ? (
                <div className="space-y-4">
                  {installmentOrders.map((order) => (
                    <Card key={order.id} className="bg-white/10 border-white/20 backdrop-blur-md">
                      <CardContent className="p-4 sm:p-6">
                        <InstallmentOrderCard order={order} onPaymentSuccess={handlePaymentSuccess} />
                      </CardContent>
                    </Card>
                  ))}
                </div>
                ...
                <Card className="bg-white/10 border-white/20 backdrop-blur-md text-center py-8 sm:py-12">
                  <CardContent className="px-4">
                    <ShoppingCart className="h-8 w-8 sm:h-12 sm:w-12 text-white/80 mx-auto mb-4" />
                    <h3 className="text-lg font-semibold mb-2 text-white">No Installment Orders</h3>
                    <p className="text-sm sm:text-base text-white/80 mb-4">
                      {isApproved
                    ...
                    {isApproved ? (
                      <Button onClick={() => setActiveTab("products")} className="w-full sm:w-auto bg-gradient-to-r from-blue-500 to-indigo-500 text-white">
                        Browse Products
                      </Button>
                    ) : (
                      <Button onClick={() => setActiveTab("registration")} className="w-full sm:w-auto bg-gradient-to-r from-blue-500 to-indigo-500 text-white">
            ...
            <TabsContent value="info" className="space-y-4 sm:space-y-6">
              <Card className="bg-white/10 border-white/20 backdrop-blur-md">
                <CardHeader>
                  <CardTitle className="text-lg sm:text-xl text-white">How Lipa Mdogo Mdogo Works</CardTitle>
                  <p className="text-xs sm:text-sm text-white/80">
                ...
                <CardContent>
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
                    <div className="text-center">
                      ...
                      <h3 className="font-semibold mb-2 text-sm sm:text-base text-white">Register & Get Approved</h3>
                      <p className="text-xs sm:text-sm text-white/80">
                    ...
                    <div className="text-center">
                      ...
                      <h3 className="font-semibold mb-2 text-sm sm:text-base text-white">Shop & Pay Deposit</h3>
                      <p className="text-xs sm:text-sm text-white/80">
                    ...
                    <div className="text-center">
                      ...
                      <h3 className="font-semibold mb-2 text-sm sm:text-base text-white">Pay Monthly</h3>
                      <p className="text-xs sm:text-sm text-white/80">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                    <div className="bg-white/10 border-white/20 backdrop-blur-md p-4 rounded-lg">
