    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        ...
        <div className="md:ml-64 p-6">
          <p className="text-red-400">Error: Wallet interface unavailable. Please try again later.</p>
        </div>
      </div>
    )
  }
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-white/80">Manage your balances and transactions</p>
            </div>
          </div>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <Card className="bg-white/10 backdrop-blur-md border border-blue-400/50 shadow-[0_0_10px_rgba(59,130,246,0.7)]">
              <CardContent className="p-6">
                <h3 className="font-semibold text-white mb-2">How Your Wallet Works</h3>
            ...
            <Card className="bg-white/10 backdrop-blur-md border border-orange-400/50 shadow-[0_0_10px_rgba(249,115,22,0.7)]">
              <CardContent className="p-6">
                <h3 className="font-semibold text-white mb-2">Deposit & Withdrawal Information</h3>
                <ul className="text-sm text-white/80 space-y-1">
